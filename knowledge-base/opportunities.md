...
|---|---|---|---|---|---|---|
| 2026-06-17 | Booz Allen Ventures | VC Associate (CVC) | Denver, CO · hybrid (confirm) | **82** | NEW | $300M corporate VC fund. **Sector bullseye** — defense tech / space / quantum / deep tech / cyber. JD = diligence + sourcing + IC memos + pipeline tools + founder/VC networking → near 1:1 with Adam's Atento sourcing/diligence + fund-ops + AI fluency. Comp band **$86.8K–$198K**. "Associate" is below his Sr-Assoc floor (flex for a strong institution; he's well-qualified at 2+ yrs req). Confirm work model + likely US-citizenship req. **Live, posted 2026-06-13** (LinkedIn 4428309259). |
...
- **Gaps / risks:** (1) Title "Associate" is below his stated floor — frame as title-flex for a top institution with a real investing mandate. (2) **Likely US-citizenship requirement** for a defense-focused CVC (not stated in JD) — confirm early; it's a potential hard gate if he can't meet it. (3) Work model (hybrid vs onsite Denver) unconfirmed. (4) Comp lands where on the band?
...
- **Next action:** Confirm citizenship + work model + where comp lands → seek warm intro → `/tailor-resume BoozAllen` (VC-investor, defense/deep-tech cut) → apply via LinkedIn. **This rivals SPLY on sector fit; prioritize.**
