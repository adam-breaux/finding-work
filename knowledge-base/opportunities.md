...
| 2026-06-17 | Kava Equity Partners | Senior Associate (PE) | Denver, CO · model TBD | ~70 (prelim) | 🔬 LEAD · researching | Direct PE arm of the Southern Ute Indian Tribe Growth Fund. **Sr Associate = at his title floor;** full deal cycle (source→underwrite→structure→close), lean team with the MD, high autonomy. Generalist lower-middle-market control buyouts. Master's req (he has MBA ✓). **Best-shaped of the 3 new Denver leads.** Live, posted 2026-06-16 (LinkedIn 4426863510). |
| 2026-06-17 | Saturn Five | Operating Partner (PE) | Denver, CO · model TBD | ~58 (prelim) | 🔬 LEAD · researching | Long-term-hold lower-middle-market PE (buy-and-hold small businesses). Hands-on "board member" to 3–6 portfolio CEOs — **operator/portfolio role, not an investor-sourcing seat.** Wants someone who's owned/run a business with true P&L/balance-sheet ownership ($2–10M EBITDA). High CEO proximity. Generalist sector. Live, posted 2026-06-16 (LinkedIn 4416445817). |
| 2026-06-17 | CB Partners (for social-impact investor) | Senior Analyst | Denver, CO · hybrid 3 days/wk | ~55 (prelim) | 🔬 LEAD · researching | Recruiter (CB Partners) filling a seat at a mission-driven **social-impact** investment org (direct + fund commitments + grantmaking). Real hands-on investing (diligence→execution→monitoring). **Concerns:** title below floor; **hybrid Denver 3×/wk is a geo strain from Tulsa**; off-thesis sector; comp **$110–150K** (at/below floor). Live, posted 2026-06-09 (LinkedIn 4406620333). |
...
### Kava Equity Partners — Senior Associate (PE)  ·  Score: ~70 (prelim)  ·  Status: 🔬 LEAD · researching
- **Source / link:** LinkedIn `4426863510` — live, posted 2026-06-16. Firm: www.kavaequity.com / www.sugf.com (Southern Ute Indian Tribe Growth Fund).
- **Quick read:** Direct PE arm of the Southern Ute Indian Tribe Growth Fund. Lower-middle-market control buyouts + opportunistic minority/secondary/private credit. Sr Associate participates in every part of the deal cycle (sourcing, underwriting, structuring, closing, portfolio mgmt, divestments), lean team, works with the MD, high autonomy. Master's in Business/Finance/Econ required (Adam's MBA qualifies).
- **Why it's promising:** Title is **at his Sr-Associate floor**; real deal ownership + MD proximity; Denver hub. Sector is generalist LMM PE (not hard tech) but the role shape is strong.
- **Research to-do:** (1) Confirm work model — remote/hybrid/onsite Denver + travel cadence (Tulsa-compatible?). (2) Comp band (undisclosed). (3) Years-of-experience bar + whether they value an operator/CoS background vs pure PE-deal pedigree. (4) Carry/co-invest. (5) Warm-intro path into the Growth Fund / Durango-Ignacio CO network. → then `/score-role`.

### Saturn Five — Operating Partner (PE)  ·  Score: ~58 (prelim)  ·  Status: 🔬 LEAD · researching
- **Source / link:** LinkedIn `4416445817` — live, posted 2026-06-16. Firm: Saturn Five (annual letters referenced in JD).
- **Quick read:** Long-term-hold lower-middle-market PE — buys and operates small businesses for the long term. Operating Partner is the "connective tissue" between funds and portfolio CEOs: hands-on board-member role across 3–6 companies, monthly financial reviews, quarterly goals, annual planning, plus hiring/onboarding portfolio CEOs. Ideal candidate has **owned or led a business with true P&L + balance-sheet responsibility** (~$2–10M EBITDA company). Base commensurate with experience.
- **Why it's a stretch:** This is an **operating/portfolio-management** seat, not an investor-sourcing/diligence seat — further from Adam's "own deals / investor proximity" target. The "ran a business with P&L" ask is a partial gap (he's CoS/operator, not a former owner-operator). CEO proximity is high (a plus). Generalist small-biz sector.
- **Research to-do:** (1) Work model + travel to portfolio cos (likely heavy travel). (2) Comp + carry. (3) Whether a CoS/operator profile (vs former business owner) clears their bar. (4) Read their annual letters to gauge culture/fit. → then decide whether to `/score-role` or pass.

### CB Partners (recruiting for a social-impact investor) — Senior Analyst  ·  Score: ~55 (prelim)  ·  Status: 🔬 LEAD · researching
- **Source / link:** LinkedIn `4406620333` — live, posted 2026-06-09. CB Partners, LLC is a search firm; the employer is an unnamed mission-driven social-impact investment organization.
- **Quick read:** Multi-strategy impact investor (direct investments + fund commitments + grantmaking) focused on human-capital / well-being / belonging. Hands-on Senior Analyst engaged through diligence, execution, portfolio monitoring, analytics; reports to an Investment Principal. Salary **$110,000–$150,000**. **Hybrid — must be in Denver 3 days/week.**
- **Why it's a stretch:** (1) **Geo strain** — 3 days/week onsite in Denver is hard to sustain from Tulsa and edges toward the relocation gate. (2) Title "Senior Analyst" is below his Sr-Associate floor. (3) Comp tops out at his floor. (4) Social-impact / human-capital sector is off his hard-tech thesis (though mission-driven could appeal). Upside: real investing exposure, multi-strategy.
- **Research to-do:** (1) Identify the actual employer (who is the impact org?) — affects firm-quality + sector read. (2) Press on the 3-day Denver cadence — any genuine remote flex? (decisive for the geo gate). (3) Title/level vs his floor. (4) Whether the mission resonates with Adam. → then `/score-role` or pass.
