...
|---|---|---|---|---|---|---|
| 2026-06-17 | **Toyota Ventures** | VC Associate (Frontier Fund) | **Remote-eligible (US)** · SF Bay Area HQ | ⭐ **85** | 🟢 NEW · ✅ live | **Best find of the VC sweep.** $800M+ deep-tech/climate fund (Joby, Stoke Space, Apex Space, Pickle Robot, Intuition Robotics, e-Zinc). Sources/screens **AI, advanced materials, automation & robotics, space tech** = **sector bullseye** for his hard-tech/physical thesis + 100 deep-tech founder interviews + SBIR/STTR fluency. **JD: "remote work within other U.S. cities is possible" → Tulsa-compatible.** Top-tier firm → title-flex applies for "Associate." Req: degree + **min 4 yrs** (he's ~3 — slight reach, defensible) + deep-tech understanding + cap tables/financials. Comp undisclosed (base + annual cash bonus). Live, 1 wk old, 38 applicants (LinkedIn 4425168501). |
...
### Toyota Ventures — VC Associate (Frontier Fund)  ·  Score: 85/100  ·  Status: NEW ✅ verified live ⭐
...
- **Next action:** **Top priority of this sweep.** `/score-role` to lock it, then `/tailor-resume Toyota` (VC-investor, deep-tech cut) and confirm remote eligibility. Strong candidate to pair with the deep-tech memo. Rivals SPLY/Booz Allen on sector + beats them on firm caliber and geo (remote).
